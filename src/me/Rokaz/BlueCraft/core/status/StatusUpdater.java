package me.Rokaz.BlueCraft.core.status;
...
public class StatusUpdater extends TimerTask {
    private static final List<String> frames = Arrays.asList("Managing BlueCraft!","Managing BlueCraft!.","Managing BlueCraft!..","Managing BlueCraft!...");
